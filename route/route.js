...
router.get("/createDepense/", depense.createDepense);
router.put("/updateDepense/:id", depense.updateDepense);
router.delete("/deleteDepense/:id", depense.deleteDepense);
// router.put("/updateChauffeur/:id",chauffeur.updateChauffeur);
// router.delete("/deleteChauffeur/:id",chauffeur.deleteChauffeur);
router.get("/getAllPaiementPosseder/", paiement.getAllPaimentPosseder);
router.get("/getAllPaiement/", paiement.getAllPaiement);
router.put("/updatePaiement/:id", paiement.updatePaiement);
router.delete("/deletePaiement/:id", paiement.deletePaiement);
